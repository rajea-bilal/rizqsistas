...
export default function CommunityPage() {
  return (
    <div className="bg-[#050505] text-[#F6F1EB] antialiased font-geist selection:bg-[#F6F1EB] selection:text-black overflow-x-hidden">
      {/* Navigation */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10 z-10 relative">
            ...
            <ul className="space-y-3 text-lg text-zinc-400 font-normal">
              ...
              <li className="flex items-center gap-3">
                <BookOpen className="w-5 h-5 text-[#F6F1EB]" />
                <span>Learn practical halal finance in community</span>
              </li>
              <li className="flex items-center gap-3">
                <Users className="w-5 h-5 text-[#F6F1EB]" />
                <span>Connect with women walking the same path</span>
              </li>
            </ul>

            <div className="flex flex-wrap gap-3 pt-2">
              <a href="#" className="bg-[#F6F1EB] text-black text-sm font-medium px-5 py-2.5 rounded-full hover:bg-zinc-200 transition-colors">
                Explore Gatherings
              </a>
              <a href="#" className="bg-zinc-900 border border-zinc-800 text-[#F6F1EB] text-sm font-medium px-5 py-2.5 rounded-full hover:bg-zinc-800 transition-colors">
                Become a Host
              </a>
            </div>
          </div>
      ...
      <section className="relative mt-20 border-t border-white/10 bg-[#050505] overflow-hidden">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none z-0">
          {/* Rizq Community Wallpaper Background */}
          <div className="absolute inset-0 w-full h-full">
            <Image 
              src="/images/wallpaper/rizq-community.png" 
              className="w-full h-full object-cover opacity-70" 
              alt="Rizq Community Background" 
              width={1920} 
              height={1080}
              priority
            />
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input type="text" className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-[#F6F1EB] focus:outline-none focus:border-zinc-600 focus:ring-1 focus:ring-zinc-600 transition-all placeholder:text-zinc-700" placeholder="Full name" />
                </div>
                <div className="space-y-1">
                  <label className="text-[11px] text-zinc-500 uppercase tracking-wider font-semibold">Email</label>
                  <input type="email" className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-[#F6F1EB] focus:outline-none focus:border-zinc-600 focus:ring-1 focus:ring-zinc-600 transition-all placeholder:text-zinc-700" placeholder="Email" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <select className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-[#F6F1EB] focus:outline-none focus:border-zinc-600 appearance-none cursor-pointer">
                ...
                <div className="space-y-1">
                  ...
                  <input type="text" className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-[#F6F1EB] focus:outline-none focus:border-zinc-600 focus:ring-1 focus:ring-zinc-600 transition-all placeholder:text-zinc-700" placeholder="City" />
                </div>
              </div>

              <div className="space-y-1">
                <label className="text-[11px] text-zinc-500 uppercase tracking-wider font-semibold">Portfolio URL</label>
                <input type="url" className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-[#F6F1EB] focus:outline-none focus:border-zinc-600 focus:ring-1 focus:ring-zinc-600 transition-all placeholder:text-zinc-700" placeholder="https://" />
              </div>

              <div className="space-y-1">
                <label className="text-[11px] text-zinc-500 uppercase tracking-wider font-semibold">Event Description</label>
                <textarea rows={3} className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-sm text-[#F6F1EB] focus:outline-none focus:border-zinc-600 focus:ring-1 focus:ring-zinc-600 transition-all placeholder:text-zinc-700 resize-none" placeholder="Describe the type of event you would like to host..."></textarea>
              </div>

              <button className="bg-[#F6F1EB] text-black text-sm font-semibold rounded-lg px-6 py-2 hover:bg-zinc-200 transition-colors mt-2">
                Apply to Host
              </button>
            </form>
          </div>
